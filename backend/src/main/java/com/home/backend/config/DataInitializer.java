...
public class DataInitializer implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) {
        ...
        List<Menu> menus = List.of(
            ...
            Menu.builder().category("프랜차이즈").subCategory("처갓집").menuName("슈프림치킨").menuType(MenuType.DELIVERY_ONLY).deliveryPrice(25000).minOrder(15000).build(),
            ...
            Menu.builder().category("프랜차이즈").subCategory("자담치킨").menuName("맵슐랭치킨").menuType(MenuType.DELIVERY_ONLY).deliveryPrice(25000).minOrder(16000).build(),
            Menu.builder().category("프랜차이즈").subCategory("네네치킨").menuName("후라이드치킨").menuType(MenuType.DELIVERY_ONLY).deliveryPrice(22000).minOrder(15000).build(),
            Menu.builder().category("프랜차이즈").subCategory("네네치킨").menuName("스노윙치킨").menuType(MenuType.DELIVERY_ONLY).deliveryPrice(25000).minOrder(15000).build(),
            ...
            Menu.builder().category("프랜차이즈").subCategory("후참잘").menuName("후라이드 치킨").menuType(MenuType.DELIVERY_ONLY).deliveryPrice(18000).minOrder(14000).build(),
            Menu.builder().category("프랜차이즈").subCategory("후참잘").menuName("양념 치킨").menuType(MenuType.DELIVERY_ONLY).deliveryPrice(19000).minOrder(14000).build(),
            Menu.builder().category("프랜차이즈").subCategory("후참잘").menuName("간장 치킨").menuType(MenuType.DELIVERY_ONLY).deliveryPrice(19000).minOrder(14000).build(),
            ...
            // 피자 전 품목
            Menu.builder().category("프랜차이즈").subCategory("반올림피자").menuName("콤비네이션 피자").menuType(MenuType.DELIVERY_ONLY).deliveryPrice(18900).minOrder(15000).build(),
            Menu.builder().category("프랜차이즈").subCategory("반올림피자").menuName("페페로니 피자").menuType(MenuType.DELIVERY_ONLY).deliveryPrice(18900).minOrder(15000).build(),
            ...
            Menu.builder().category("프랜차이즈").subCategory("피자에땅").menuName("불고기 피자").menuType(MenuType.DELIVERY_ONLY).deliveryPrice(21900).minOrder(15000).build(),
            Menu.builder().category("프랜차이즈").subCategory("피자에땅").menuName("고구마 피자").menuType(MenuType.DELIVERY_ONLY).deliveryPrice(20900).minOrder(15000).build(),
            ...
            Menu.builder().category("프랜차이즈").subCategory("피자에땅").menuName("페페로니 피자").menuType(MenuType.DELIVERY_ONLY).deliveryPrice(20900).minOrder(15000).build(),
            ...
            // 중식 전 품목
            Menu.builder().category("중식").subCategory("면").menuName("짜장면").menuType(MenuType.NO_COOKING).deliveryPrice(7000).minOrder(10000).kitPrice(5500).build(),
            Menu.builder().category("중식").subCategory("면").menuName("짬뽕").menuType(MenuType.NO_COOKING).deliveryPrice(8000).minOrder(10000).kitPrice(6000).build(),
            Menu.builder().category("중식").subCategory("면").menuName("해물짬뽕 / 불짬뽕").menuType(MenuType.NO_COOKING).deliveryPrice(9000).minOrder(12000).build(),
            Menu.builder().category("중식").subCategory("면").menuName("차돌박이짬뽕").menuType(MenuType.NO_COOKING).deliveryPrice(10000).minOrder(12000).build(),
            Menu.builder().category("중식").subCategory("면").menuName("간짜장").menuType(MenuType.NO_COOKING).deliveryPrice(8000).minOrder(10000).build(),
